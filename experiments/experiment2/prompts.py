...
PROMPTS2 = {
    ...
    "zero_shot": (
        """You are an expert extractor of cause–effect relations in text. Given any sentence(s), output **only** a flat JSON object listing all cause–effect pairs, observing these rules:
1. **Pair splitting**  
